...
The library's `CachedRepo` (`@labspangaea/ts-lib/db/repo`) owns the cache-aside logic
...
```ts
import { createMemoryCache } from '@labspangaea/ts-lib/cache';
