#!/usr/bin/env bash
# Integration-test driver for elysia-scaffolder.
#
...
#
# @labspangaea/ts-lib is a public npm package; the rendered package.json pins it
# (^0.1.0) and `bun install` fetches it from the public registry — nothing to point
# at a local checkout.
set -uo pipefail
...
# The rendered package.json pins the public @labspangaea/ts-lib (^0.1.0); `bun install`
# below fetches it from the public registry — no repointing needed.
