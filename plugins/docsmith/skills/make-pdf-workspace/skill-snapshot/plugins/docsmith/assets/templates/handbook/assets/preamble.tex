...
\newtcolorbox{protip}{enhanced, breakable, boxrule=0.4pt, arc=2.4mm,
  ...
  coltitle=white, title=Pro Tip, fonttitle=\bfseries\sffamily\footnotesize,
...
\@ifundefined{Shaded}{\newenvironment}{\renewenvironment}{Shaded}
  {\begin{tcolorbox}[breakable, enhanced, boxrule=0pt, arc=1.6mm,
     colback=codebg, colframe=codebg,
     borderline west={2.2pt}{0pt}{navysoft},
