...
Local style rules baked into the scaffolder templates. The cross-cutting `labspangaea-code-standard/references/go.md` is the broader rulebook for the wider codebase; what's here is the subset the templates enforce by construction.
