// render-file renders a single go-peruri-lib scaffold template to a file (or
...
// Example:
//
//	PARAMS='{"Name":"order-service","Module":"sipgn-git.bgn.go.id/harry.sitohang/order-service",
